        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            ...
            <TextInput
              ...
              placeholder="Prodi"
              value={form.prodi}
              onChangeText={(t) => setForm({ ...form, prodi: t })}
            />
            <TextInput
              style={styles.input}
              placeholder="Kelas"
...
const styles = StyleSheet.create({
  ...
  cardList: { gap: 12 },
  card: { backgroundColor: '#fff', borderRadius: 12, padding: 16, borderWidth: 1, borderColor: '#e8e8e8', elevation: 2 },
  cardHeaderAction: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', borderBottomWidth: 1, borderBottomColor: '#eee', paddingBottom: 10, marginBottom: 10 },
  ...
  row: { flexDirection: 'row', alignItems: 'center', borderBottomWidth: 1, borderBottomColor: '#e0e0e0', paddingVertical: 14, paddingHorizontal: 6 },
  headerRow: { backgroundColor: '#1A237E', paddingVertical: 12 },
  ...
  cellActionWrapper: { width: 100, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6 },

  btnEdit: { backgroundColor: '#e3f2fd', paddingVertical: 5, paddingHorizontal: 10, borderRadius: 6 },
  btnEditText: { fontSize: 12, color: '#0a7ea4', fontWeight: '600' },
  btnDelete: { backgroundColor: '#ffebee', paddingVertical: 5, paddingHorizontal: 10, borderRadius: 6 },
  btnDeleteText: { fontSize: 12, color: '#b71c1c', fontWeight: '600' },

  btnRefresh: { alignSelf: 'flex-start', marginTop: 20, backgroundColor: '#1A237E', paddingVertical: 12, paddingHorizontal: 18, borderRadius: 10 },
  ...
  input: { borderBottomWidth: 1, borderBottomColor: '#ddd', paddingVertical: 8, marginBottom: 15 },
  modalBtns: { flexDirection: 'row', justifyContent: 'flex-end', gap: 10 },
  btn: { paddingVertical: 10, paddingHorizontal: 20, borderRadius: 8 },
  btnCancel: { backgroundColor: '#eee' },
  btnSave: { backgroundColor: '#1A237E' },
});